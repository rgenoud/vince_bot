...
class MUCJabberBot(JabberBot):
	...
	self.other_str = [ "pause !", "mais qu'est-ce qu'on fout là ?", "j'suis putain de las !", "on va au resto ?", "sérieux ?", "la loose...", "rheuuuuuuuuuuuu", "et ben on est pas rendu avec ça !"]
        self.direct_str = [ "ben chais pas", "parles-moi pas toi !", "kestuveux ?!", "vas-y lâche-moi !", "putain, j'dormais...", "pffff ! mais qu'est-ce j'en sais moi ?!", "honnêtement, je m'en bats les couilles.", "qu'est-ce que tu veux que ça me fasse ?", "t'sais quoi ? ça m'en touche une sans faire bouger l'autre !", "Parle à ma main !", "Wouhaa ! mais c'est génial !", "Putain, c'est trop d'la balle", "et tu me déranges pour me dire ça ? Ben tu ferais mieux de retourner shaper un coup !", "je bois les mots à tes lèvres tel cendrillon la sève au gland du prince charmant", "<Abraham Simpson>Faut que j'aille prendre mes médicaments</Abraham Simpson>", "Je ne pine rien à ce que tu me bave" ]
        self.choub_str = ["choub: !!!!!!!", "choub: !$%#+@", "choub: bordel !" ]
        self.procedures_str = ["putain, mais on chie sur les procedures là !!!", "pffffff !!!", "ok, mais on timeout à 30 alors !!!", "Nan, c'est maintenant ! benoît: go" ]
